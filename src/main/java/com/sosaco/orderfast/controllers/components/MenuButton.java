...
public class MenuButton extends VBox {
    ...
    public void setIcon(ButtonIcon icon) {
        ...
        String svgIcon  = switch (icon){
            ...
            case BILLING -> "M10.5 4.3L12 3.1l1.5 1.2h1.3L12 2 9.2 4.3M11.1 7.3c-.2.1-.3.1-.4.2-.1.1-.2.2-.2.3 0 .1-.1.3-.1.4 0 .2 0 .3.1.4.1.1.1.2.2.3.1.1.2.2.3.2.1 0 .3.1.5.1h.1V7.1c-.2.1-.4.2-.5.2zM12.6 10.2l-.3-.1v2.3c.1 0 .3 0 .4-.1.2 0 .4-.1.5-.2.1-.1.2-.2.3-.4.1-.1.1-.3.1-.5 0-.3-.1-.5-.3-.6 0-.1-.3-.3-.7-.4z M10.3 15.5l1.7-1.1 1.7 1.1 4.2-3V5.1H6.2v7.4l4.1 3zm1.3-5.5h-.2c-.2 0-.4-.1-.6-.2-.2-.1-.4-.2-.5-.3-.2-.1-.4-.3-.5-.5-.1-.2-.1-.4-.1-.7v-.4c0-.2.1-.4.3-.6.1-.2.4-.4.6-.5.2-.1.5-.2.9-.3v-.4h.7v.4c.5 0 1 .2 1.3.5.4.3.6.9.7 1.6v.2h-.7v-.2c0-.5-.2-.8-.4-1-.2-.2-.5-.3-.8-.3v2.2l.5.1c.3.1.6.2.8.3.2.1.4.2.5.4.1.2.2.3.3.5.1.2.1.4.1.6 0 .4-.1.7-.2.9-.1.2-.3.4-.5.6-.2.1-.5.3-.7.3-.2 0-.4.1-.6.1v.8h-.7v-.8c-.3 0-.5-.1-.7-.2-.3-.1-.5-.2-.7-.4-.2-.2-.4-.4-.5-.7-.1-.3-.2-.6-.2-1v-.2h.7v.2c0 .5.1.9.4 1.1.2.2.5.4 1 .4l-.2-2.5z M18.7 7.3v1.1l2.5 2v.1l-6.8 5.4 6.5 4.3.2.6H21l-9-5.3-9.1 5.4.2-.6L9.6 16l-6.8-5.4v-.1l2.5-2V7.3L2 10v10.4c0 .9.7 1.6 1.6 1.6h16.9c.9 0 1.6-.7 1.6-1.6V10l-3.4-2.7z";
        };

        String svgWidth = switch (icon){
            case RECIPES-> "45px";
            case INVENTORY, SETTINGS, ORDERS, ADD, BILLING-> "60px";
        };
